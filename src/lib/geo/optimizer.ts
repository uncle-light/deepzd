...
import { GeoStrategy } from './strategy-analyzer';
...
export async function optimizeContent(
  ...
  // Extract changes summary (simple diff detection)
...
/**
 * Change detection i18n dictionary
 */
const CHANGE_I18N = {
...
/**
 * Simple change detection for summary
 */
function detectChanges(original: string, optimized: string, locale: string): string[] {
  ...
  const diff = optLength - origLength;
